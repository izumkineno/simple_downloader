...
|-------------------|-----------|----------|
| 0.2.x | 1.85 | `tokio 1.52` `reqwest 0.13` `thiserror 2` `bytes 1` `faststr 0.2` `futures-util 0.3` `bitcode 0.6` (resume) |
| 0.1.x | 1.85 | 同 0.2.x，API 兼容，仅性能与文档差异 |
旧文 `tokio 1.0~1.35 / reqwest 0.11 / thiserror 1 / serde+bincode` 已过时。
