...
> `simple_downloader = "0.1.0"` **不会** 默认启用任何可选功能，旧文“默认启用所有”已过时。
...
|-------------------|-----------|----------|
| 0.1.x | 1.85 | `tokio 1.52` `reqwest 0.13` `thiserror 2` `bytes 1` `faststr 0.2` `futures-util 0.3` `bitcode 0.6` (resume) |
